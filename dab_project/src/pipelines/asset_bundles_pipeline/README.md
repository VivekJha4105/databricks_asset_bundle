# asset_bundles_pipeline

This folder defines all source code for the 'asset_bundles_pipeline' pipeline:
...
* Take a look at the sample under "sample_users_asset_bundles_pipeline.py" to get familiar with the syntax.
